# ECS Task Execution Role - used by ECS agent to pull images, write logs, retrieve secrets
...
# ECS Task Role - used by the application for AWS API access
...
resource "aws_iam_role_policy" "task_custom" {
  name = "${var.name_prefix}-task-custom"
